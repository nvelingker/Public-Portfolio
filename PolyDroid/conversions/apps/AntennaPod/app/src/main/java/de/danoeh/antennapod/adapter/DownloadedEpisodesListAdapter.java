...
public class DownloadedEpisodesListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            //Version2 COMMENT OUT
            holder.butSecondary = (ImageButton) convertView
                    .findViewById(R.id.butSecondaryAction);
            //VERSION2 COMMENT IN
//            holder.butSecondary = (Button) convertView
//                    .findViewById(R.id.butSecondaryAction);
        ...
        Log.d("imginfo", (holder.imageView.getImageMatrix().toString()));
        Log.d("imginfo", Integer.toString(holder.imageView.getMeasuredHeight()));
