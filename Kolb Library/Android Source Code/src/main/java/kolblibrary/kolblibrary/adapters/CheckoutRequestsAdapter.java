...
public class CheckoutRequestsAdapter extends CatalogSearchAdapter {

    private LinkedHashMap<UserInfo, Book> info;
    public CheckoutRequestsAdapter(Context C, LinkedHashMap<UserInfo, Book> a, HashMap<Integer, Bitmap> images){
        super(C, a, images);
        info = a;
    }
    ...
    public View getView(int i, View v, ViewGroup viewGroup) {
        ...
        TextView ReqNameView = (TextView) v.findViewById(R.id.RequestNameView);
        TextView DateReqView = (TextView) v.findViewById(R.id.DateRequestedView);
        ImageView Image = (ImageView) v.findViewById(R.id.bookImg);
